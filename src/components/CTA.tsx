  ...
  return (
    <div className="bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-primary to-secondary rounded-3xl overflow-hidden shadow-lg">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="relative h-full min-h-[300px] flex items-center justify-center p-8">
                <div className="w-full max-w-sm aspect-square rounded-full border-4 border-white/30 flex items-center justify-center">
